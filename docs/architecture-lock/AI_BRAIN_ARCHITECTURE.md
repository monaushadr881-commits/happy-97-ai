...
## Summary
Canonical: `brain-v4.functions.ts` + `src/brain/*`. Engines: intent, context, memory, capability, reasoning, planning, execution, validation, reflection, learning, safety, analytics, confidence, priority. Frozen at R111 §4.
