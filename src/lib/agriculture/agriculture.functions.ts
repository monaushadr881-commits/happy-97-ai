/**
 * R189 Batch 8 — Agriculture Runtime (Canonical Owner)
 *
 ...
 *
 * Foundation Modules: farm, crop, livestock, equipment,
...
>({
  ...
  handler: ({ module, cost_cents, critical }) => {
    ...
    const criticalModule = module === "livestock" || module === "equipment";
