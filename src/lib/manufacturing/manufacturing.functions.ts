/**
 * R189 Batch 8 — Manufacturing Runtime (Canonical Owner)
 *
 ...
 *
 * Foundation Modules: factory, production, machine, maintenance,
...
>({
  ...
  handler: ({ module, cost_cents, critical }) => {
    ...
    const criticalModule = module === "maintenance" || module === "quality";
