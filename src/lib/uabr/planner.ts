...
// Ordered from most specific → least specific so unambiguous multi-word
// prompts don't get captured by broader industries (e.g. "ecommerce store
// online" must classify as ecommerce, not retail; "shop-floor tracker" must
// classify as manufacturing, not retail).
const INDUSTRY_MAP: { keywords: string[]; industry: UabrIndustry; modules: string[]; features: string[] }[] = [
  ...
  { keywords: ["manufactur", "factory", "assembly", "shop-floor", "shop floor", "production line"], industry: "manufacturing",
  ...
  { keywords: ["hotel", "room", "stay", "reservation"], industry: "hotel",
  ...
  { keywords: ["retail", "store", "pos"], industry: "retail",
